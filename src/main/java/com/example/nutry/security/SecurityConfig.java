...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
                ...
                .antMatchers(HttpMethod.POST, "/updateuserprofiledetails").authenticated()  // allowed by anyone
                .antMatchers(HttpMethod.GET, "/updateuserprofiledetails").authenticated()  // allowed by anyone
...
//                .antMatchers(HttpMethod.DELETE, "/vehicles/**").hasRole("ADMIN") // allowed if signed in with ADMIN role
                ...
                .antMatchers(HttpMethod.GET, "/addwater").permitAll() // allowed by anyone
                .antMatchers(HttpMethod.POST, "/addwater").permitAll()
